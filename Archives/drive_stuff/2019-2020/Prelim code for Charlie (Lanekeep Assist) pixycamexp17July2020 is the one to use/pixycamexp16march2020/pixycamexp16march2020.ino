...
void loop()
{
  ...
  if((pixy.line.vectors[i].m_x0>=18 && pixy.line.vectors[i].m_x0 <=23)||(pixy.line.vectors[i].m_x0 >= 64&& pixy.line.vectors[i].m_x0<=69)){
    ...
    }else if ((pixy.line.vectors[i].m_x0 >23&&pixy.line.vectors[i].m_x0<=36)||pixy.line.vectors[i].m_x0 >= 69){
      Serial.print("go to the left");
      }else if (pixy.line.vectors[i].m_x0<18||pixy.line.vectors[i].m_x0<64){
