...
if(pixy.line.numVectors==0){
  ...
  if((pixy.line.vectors[i].m_x1>=68 && pixy.line.vectors[i].m_x1 <73)){
    ...
    else if((pixy.line.vectors[i].m_x1>=0 && pixy.line.vectors[i].m_x1<68)){
      Serial.print("left");
      Left();
  }else if((pixy.line.vectors[i].m_x1>=73 && pixy.line.vectors[i].m_x1<=78)
  ){
     Serial.print("right");
      Right();
  }
