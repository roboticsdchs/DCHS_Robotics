...
void loop()
{
  ...
  for (i=0; i<pixy.line.numVectors; i++)
  {
   ...
   for(i = 0; i<pixy.line.numVectors; i++){
  if(pixy.line.vectors[i].m_x0 <=23||pixy.line.vectors[i].m_x0 >= 65){
    Serial.print("in the zone");
    }else {
      Serial.print("go to the left");
      }
  }
  /*todo establish better system defining the boundaries, expand to say whether to go right or left*/
