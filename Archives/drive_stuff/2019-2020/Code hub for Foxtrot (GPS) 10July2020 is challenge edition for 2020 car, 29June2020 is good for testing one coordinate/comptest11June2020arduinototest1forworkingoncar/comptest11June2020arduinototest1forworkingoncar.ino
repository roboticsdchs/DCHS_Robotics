...
int center = 120;
int rightangle = 127; //for 45 degree angle plus 7
int TrueSpeed;
int Angle;
int moveport = 9;
int turnport = 10;
int slightleftangle = 116; //minus 4
int slightrightangle = 124; //plus 4
int endlight = 13;
...
double TLatitude =  42.302936;
double TLongitude  =  -83.430351;
double CLatitude;
double CLongitude;
...
double changeheading(float hdg, float brg) {
  ...
  if (diffheading > 30 && diffheading < 60) {
    slightLeft();
    return Serial.println("45") ;
  } else if (diffheading < -30 && diffheading > -60) {
    slightRight();
    return Serial.println("-45");
  } else if (diffheading > 60) {
    Left();
    return Serial.println("65");
