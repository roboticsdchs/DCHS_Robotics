...
/*double getWaypointHeading(double targetLatitude, double targetLongitude, double currentLatitude, double currentLongitude) {
double x = cos(currentLatitude) * sin(currentLatitude - targetLatitude);
double y = cos(targetLatitude) * sin(currentLatitude) - sin(targetLatitude) * cos(currentLatitude) * cos(targetLongitude - currentLongitude);
  
  // radians
  double heading = atan2(y, x);

  // convert to degrees 0 to 180/-180
   double degrees_1 =  heading * (180 / 3.14159265358979323846264338327950288419716939937510582);
