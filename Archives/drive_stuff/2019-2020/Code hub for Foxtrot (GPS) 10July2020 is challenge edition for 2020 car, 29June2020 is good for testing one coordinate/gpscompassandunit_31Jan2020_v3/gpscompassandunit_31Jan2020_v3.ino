...
void loop()
{
 SerialMonitor.print("Lat: "); SerialMonitor.println(tinyGPS.location.lat(), 50);
  ...
  //SerialMonitor.print("turnheading:");
  turnheading(tinyGPS.course.deg(),  bearing(CLatitude, CLongitude, TLatitude, TLongitude));
 // SerialMonitor.print("turncompass:");
 SerialMonitor.println("degree");
 turncompass(compass(), bearing(CLatitude, CLongitude, TLatitude, TLongitude));
  delay(1000); 
}
