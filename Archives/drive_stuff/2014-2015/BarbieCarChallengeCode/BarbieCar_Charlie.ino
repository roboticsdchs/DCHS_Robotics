...
//#include "Adafruit_sTCS34725.h" //Another Part of the Library
...
void loop(){
    ...
    while(calculateCompassDeviation()>-88){
    ...
    while(calculateCompassDeviation()>-90){
      left(standardTurnSpeed);
    }
    initCompass();
    ...
    while(calculateCompassDeviation()>-110){
      left(standardTurnSpeed);
    }
    initCompass();
    ...
    while(calculateCompassDeviation()<179){
      right(standardTurnSpeed);
    }
    initCompass();
    while(calculateCompassDeviation()<31){
      right(standardTurnSpeed);
    }
    initCompass();
